...
var FS = {
    ...
    , streams: [], nextInode: 1, nameTable: null, currentPath: "/", initialized: false, ignorePermissions: true, ErrnoError: class {
        constructor(errno) {
    ...
    , filesystems: null, syncFSRequests: 0, FSStream: class {
        constructor() {
            this.shared = {
            }
        }
...
var GL = {
    counter: 1, buffers: [], programs: [], framebuffers: [], renderbuffers: [], textures: [], shaders: [], vaos: [], contexts: [], offscreenCanvases: {
    }
    , queries: [], stringCache: {
    }
    , unpackAlignment: 4, unpackRowLength: 0, recordError: errorCode => {
        if (!GL.lastError) {
        ...
        switch (typeof result) {
            ...
            case "object": if (result === null) {
                ...
                try {
                    ...
                    GL.recordError(1280);
                    err(`GL_INVALID_ENUM in glGet${type}
v: Unknown object returned from WebGL getParameter(${name_}
)! (error: ${e}
)`);
                    return
                }
            ...
            default: GL.recordError(1280);
                err(`GL_INVALID_ENUM in glGet${type}
v: Native code calling glGet${type}
v(${name_}
...
var _glGetString = name_ => {
    ...
    if (!ret) {
        switch (name_) {
            case 7939: ret = stringToNewUTF8(webglGetExtensions().join(" "));
                break;
...
function GLFW_Window(id, width, height, framebufferWidth, framebufferHeight, title, monitor, share) {
    ...
    this.attributes = Object.assign({
        ...
        , GLFW.hints);
    this.inputModes = {
        208897: 212993, 208898: 0, 208899: 0
    }
        ;
    this.buttons = 0;
    this.keys = new Array;
...
var GLFW = {
    ...
    , joystickFunc: 0, errorFunc: 0, monitorFunc: 0, active: null, scale: null, windows: null, monitors: null, monitorString: null, versionString: null, initialTime: null, extensions: null, devicePixelRatioMQL: null, hints: null, primaryTouchId: null, defaultHints: {
        131073: 0, 131074: 0, 131075: 1, 131076: 1, 131077: 1, 131082: 0, 135169: 8, 135170: 8, 135171: 8, 135172: 8, 135173: 24, 135174: 8, 135175: 0, 135176: 0, 135177: 0, 135178: 0, 135179: 0, 135180: 0, 135181: 0, 135182: 0, 135183: 0, 139265: 196609, 139266: 1, 139267: 0, 139268: 0, 139269: 0, 139270: 0, 139271: 0, 139272: 0, 139276: 0
    }
    ...
    , getTime: () => _emscripten_get_now() / 1e3, setWindowTitle: (winid, title) => {
    ...
    , lastGamepadState: [], lastGamepadStateFrame: null, refreshJoysticks: () => {
        if (Browser.mainLoop.currentFrameNumber !== GLFW.lastGamepadStateFrame || !Browser.mainLoop.currentFrameNumber) {
            ...
            for (var joy = 0;
                joy < GLFW.lastGamepadState.length;
                ++joy) {
                ...
                if (gamepad) {
                    if (!GLFW.joys[joy]) {
                        ...
                        GLFW.joys[joy] = {
                            id: stringToNewUTF8(gamepad.id), buttonsCount: gamepad.buttons.length, axesCount: gamepad.axes.length, buttons: _malloc(gamepad.buttons.length), axes: _malloc(gamepad.axes.length * 4)
                        }
                            ;
...
`);
    ...
    , createWindow: (width, height, title, monitor, share) => {
        var i, id;
        for (i = 0;
            i < GLFW.windows.length && GLFW.windows[i] !== null;
            i++) {
        }
        ...
        if (i == GLFW.windows.length) {
            if (useWebGL) {
                var contextAttributes = {
                    antialias: GLFW.hints[135181] > 1, depth: GLFW.hints[135173] > 0, stencil: GLFW.hints[135174] > 0, alpha: GLFW.hints[135172] > 0
                }
                    ;
    ...
    , destroyWindow: winid => {
        ...
        for (var i = 0;
            i < GLFW.windows.length;
            i++)if (GLFW.windows[i] !== null) return;
    ...
    , GLFW2ParamToGLFW3Param: param => {
        var table = {
            196609: 0, 196610: 0, 196611: 0, 196612: 0, 196613: 0, 196614: 0, 131073: 0, 131074: 0, 131075: 0, 131076: 0, 131077: 135169, 131078: 135170, 131079: 135171, 131080: 135172, 131081: 135173, 131082: 135174, 131083: 135183, 131084: 135175, 131085: 135176, 131086: 135177, 131087: 135178, 131088: 135179, 131089: 135180, 131090: 0, 131091: 135181, 131092: 139266, 131093: 139267, 131094: 139270, 131095: 139271, 131096: 139272
        }
            ;
        return table[param]
    }
...
var _strftime = (s, maxsize, format, tm) => {
    ...
    var EXPANSION_RULES_2 = {
        ...
        , "%d": date => leadingNulls(date.tm_mday, 2), "%e": date => leadingSomething(date.tm_mday, 2, " "), "%g": date => getWeekBasedYear(date).toString().substring(2), "%G": getWeekBasedYear, "%H": date => leadingNulls(date.tm_hour, 2), "%I": date => {
...
var preloadedAudios = {};
var wasmImports = {
    xa: GetWindowInnerHeight, ya: GetWindowInnerWidth, ce: ___cxa_throw, ab: ___syscall_faccessat, F: ___syscall_fcntl64, Ua: ___syscall_getcwd, Wa: ___syscall_ioctl, Xa: ___syscall_openat, Sa: __abort_js, Ya: __emscripten_get_now_is_monotonic, $a: __emscripten_memcpy_js, _a: _emscripten_date_now, S: _emscripten_get_element_css_size, ra: _emscripten_get_gamepad_status, r: _emscripten_get_now, sa: _emscripten_get_num_gamepads, Od: _emscripten_glActiveTexture, Nd: _emscripten_glAttachShader, M: _emscripten_glBeginQueryEXT, Md: _emscripten_glBindAttribLocation, Ld: _emscripten_glBindBuffer, Kd: _emscripten_glBindFramebuffer, Jd: _emscripten_glBindRenderbuffer, Id: _emscripten_glBindTexture, Wd: _emscripten_glBindVertexArrayOES, Hd: _emscripten_glBlendColor, Gd: _emscripten_glBlendEquation, Fd: _emscripten_glBlendEquationSeparate, Ed: _emscripten_glBlendFunc, Dd: _emscripten_glBlendFuncSeparate, Cd: _emscripten_glBufferData, Bd: _emscripten_glBufferSubData, Ad: _emscripten_glCheckFramebufferStatus, zd: _emscripten_glClear, xd: _emscripten_glClearColor, wd: _emscripten_glClearDepthf, vd: _emscripten_glClearStencil, ud: _emscripten_glColorMask, td: _emscripten_glCompileShader, sd: _emscripten_glCompressedTexImage2D, rd: _emscripten_glCompressedTexSubImage2D, qd: _emscripten_glCopyTexImage2D, pd: _emscripten_glCopyTexSubImage2D, od: _emscripten_glCreateProgram, md: _emscripten_glCreateShader, ld: _emscripten_glCullFace, kd: _emscripten_glDeleteBuffers, jd: _emscripten_glDeleteFramebuffers, id: _emscripten_glDeleteProgram, O: _emscripten_glDeleteQueriesEXT, hd: _emscripten_glDeleteRenderbuffers, gd: _emscripten_glDeleteShader, fd: _emscripten_glDeleteTextures, Vd: _emscripten_glDeleteVertexArraysOES, ed: _emscripten_glDepthFunc, dd: _emscripten_glDepthMask, cd: _emscripten_glDepthRangef, bd: _emscripten_glDetachShader, ad: _emscripten_glDisable, $c: _emscripten_glDisableVertexAttribArray, _c: _emscripten_glDrawArrays, Rd: _emscripten_glDrawArraysInstancedANGLE, Sd: _emscripten_glDrawBuffersWEBGL, Zc: _emscripten_glDrawElements, Qd: _emscripten_glDrawElementsInstancedANGLE, Yc: _emscripten_glEnable, Xc: _emscripten_glEnableVertexAttribArray, L: _emscripten_glEndQueryEXT, Wc: _emscripten_glFinish, Vc: _emscripten_glFlush, Uc: _emscripten_glFramebufferRenderbuffer, Tc: _emscripten_glFramebufferTexture2D, Sc: _emscripten_glFrontFace, Rc: _emscripten_glGenBuffers, Pc: _emscripten_glGenFramebuffers, P: _emscripten_glGenQueriesEXT, Oc: _emscripten_glGenRenderbuffers, Nc: _emscripten_glGenTextures, Ud: _emscripten_glGenVertexArraysOES, Qc: _emscripten_glGenerateMipmap, Mc: _emscripten_glGetActiveAttrib, Lc: _emscripten_glGetActiveUniform, Kc: _emscripten_glGetAttachedShaders, Jc: _emscripten_glGetAttribLocation, Ic: _emscripten_glGetBooleanv, Hc: _emscripten_glGetBufferParameteriv, Gc: _emscripten_glGetError, Fc: _emscripten_glGetFloatv, Ec: _emscripten_glGetFramebufferAttachmentParameteriv, Dc: _emscripten_glGetIntegerv, Bc: _emscripten_glGetProgramInfoLog, Cc: _emscripten_glGetProgramiv, Yd: _emscripten_glGetQueryObjecti64vEXT, _d: _emscripten_glGetQueryObjectivEXT, Xd: _emscripten_glGetQueryObjectui64vEXT, Zd: _emscripten_glGetQueryObjectuivEXT, $d: _emscripten_glGetQueryivEXT, zc: _emscripten_glGetRenderbufferParameteriv, xc: _emscripten_glGetShaderInfoLog, wc: _emscripten_glGetShaderPrecisionFormat, vc: _emscripten_glGetShaderSource, yc: _emscripten_glGetShaderiv, uc: _emscripten_glGetString, tc: _emscripten_glGetTexParameterfv, sc: _emscripten_glGetTexParameteriv, oc: _emscripten_glGetUniformLocation, rc: _emscripten_glGetUniformfv, qc: _emscripten_glGetUniformiv, lc: _emscripten_glGetVertexAttribPointerv, nc: _emscripten_glGetVertexAttribfv, mc: _emscripten_glGetVertexAttribiv, kc: _emscripten_glHint, jc: _emscripten_glIsBuffer, ic: _emscripten_glIsEnabled, hc: _emscripten_glIsFramebuffer, gc: _emscripten_glIsProgram, N: _emscripten_glIsQueryEXT, fc: _emscripten_glIsRenderbuffer, dc: _emscripten_glIsShader, cc: _emscripten_glIsTexture, Td: _emscripten_glIsVertexArrayOES, bc: _emscripten_glLineWidth, ac: _emscripten_glLinkProgram, $b: _emscripten_glPixelStorei, _b: _emscripten_glPolygonOffset, ae: _emscripten_glQueryCounterEXT, Zb: _emscripten_glReadPixels, Yb: _emscripten_glReleaseShaderCompiler, Xb: _emscripten_glRenderbufferStorage, Wb: _emscripten_glSampleCoverage, Vb: _emscripten_glScissor, Ub: _emscripten_glShaderBinary, Tb: _emscripten_glShaderSource, Sb: _emscripten_glStencilFunc, Rb: _emscripten_glStencilFuncSeparate, Qb: _emscripten_glStencilMask, Pb: _emscripten_glStencilMaskSeparate, Ob: _emscripten_glStencilOp, Nb: _emscripten_glStencilOpSeparate, Mb: _emscripten_glTexImage2D, Lb: _emscripten_glTexParameterf, Kb: _emscripten_glTexParameterfv, Jb: _emscripten_glTexParameteri, Ib: _emscripten_glTexParameteriv, Hb: _emscripten_glTexSubImage2D, Gb: _emscripten_glUniform1f, Fb: _emscripten_glUniform1fv, Eb: _emscripten_glUniform1i, Db: _emscripten_glUniform1iv, Cb: _emscripten_glUniform2f, Ab: _emscripten_glUniform2fv, zb: _emscripten_glUniform2i, yb: _emscripten_glUniform2iv, xb: _emscripten_glUniform3f, wb: _emscripten_glUniform3fv, vb: _emscripten_glUniform3i, ub: _emscripten_glUniform3iv, tb: _emscripten_glUniform4f, sb: _emscripten_glUniform4fv, rb: _emscripten_glUniform4i, qb: _emscripten_glUniform4iv, pb: _emscripten_glUniformMatrix2fv, ob: _emscripten_glUniformMatrix3fv, nb: _emscripten_glUniformMatrix4fv, mb: _emscripten_glUseProgram, lb: _emscripten_glValidateProgram, kb: _emscripten_glVertexAttrib1f, jb: _emscripten_glVertexAttrib1fv, ib: _emscripten_glVertexAttrib2f, hb: _emscripten_glVertexAttrib2fv, gb: _emscripten_glVertexAttrib3f, fb: _emscripten_glVertexAttrib3fv, eb: _emscripten_glVertexAttrib4f, db: _emscripten_glVertexAttrib4fv, Pd: _emscripten_glVertexAttribDivisorANGLE, cb: _emscripten_glVertexAttribPointer, bb: _emscripten_glViewport, Ta: _emscripten_resize_heap, ta: _emscripten_sample_gamepad_data, wa: _emscripten_set_canvas_element_size, $: _emscripten_set_click_callback_on_thread, ba: _emscripten_set_fullscreenchange_callback_on_thread, W: _emscripten_set_gamepadconnected_callback_on_thread, U: _emscripten_set_gamepaddisconnected_callback_on_thread, de: _emscripten_set_main_loop, aa: _emscripten_set_resize_callback_on_thread, X: _emscripten_set_touchcancel_callback_on_thread, Z: _emscripten_set_touchend_callback_on_thread, Y: _emscripten_set_touchmove_callback_on_thread, _: _emscripten_set_touchstart_callback_on_thread, za: _emscripten_set_window_title, Pa: _environ_get, Qa: _environ_sizes_get, Q: _exit, G: _fd_close, Va: _fd_read, Na: _fd_seek, E: _fd_write, k: _glActiveTexture, y: _glAttachShader, g: _glBindAttribLocation, b: _glBindBuffer, c: _glBindTexture, Bb: _glBlendFunc, n: _glBufferData, q: _glBufferSubData, H: _glClear, I: _glClearColor, Ma: _glClearDepthf, Ea: _glCompileShader, Ia: _glCompressedTexImage2D, Ca: _glCreateProgram, Ga: _glCreateShader, pc: _glCullFace, l: _glDeleteBuffers, B: _glDeleteProgram, C: _glDeleteShader, A: _glDeleteTextures, Za: _glDepthFunc, D: _glDetachShader, Ac: _glDisable, m: _glDisableVertexAttribArray, yd: _glDrawArrays, nd: _glDrawElements, J: _glEnable, e: _glEnableVertexAttribArray, Ra: _glFrontFace, o: _glGenBuffers, Ka: _glGenTextures, t: _glGetAttribLocation, ec: _glGetFloatv, Aa: _glGetProgramInfoLog, x: _glGetProgramiv, Da: _glGetShaderInfoLog, z: _glGetShaderiv, i: _glGetString, s: _glGetUniformLocation, Ba: _glLinkProgram, La: _glPixelStorei, Ha: _glReadPixels, Fa: _glShaderSource, Ja: _glTexImage2D, K: _glTexParameterf, h: _glTexParameteri, be: _glUniform1i, V: _glUniform4f, ua: _glUniformMatrix4fv, p: _glUseProgram, f: _glVertexAttribPointer, j: _glViewport, v: _glfwCreateWindow, oa: _glfwDefaultWindowHints, R: _glfwDestroyWindow, w: _glfwGetPrimaryMonitor, a: _glfwGetTime, na: _glfwGetVideoModes, pa: _glfwInit, ca: _glfwMakeContextCurrent, ha: _glfwSetCharCallback, da: _glfwSetCursorEnterCallback, fa: _glfwSetCursorPosCallback, ja: _glfwSetDropCallback, qa: _glfwSetErrorCallback, ia: _glfwSetKeyCallback, ga: _glfwSetMouseButtonCallback, ea: _glfwSetScrollCallback, ka: _glfwSetWindowFocusCallback, la: _glfwSetWindowIconifyCallback, T: _glfwSetWindowShouldClose, ma: _glfwSetWindowSizeCallback, va: _glfwSwapBuffers, u: _glfwTerminate, d: _glfwWindowHint, Oa: _strftime_l
};
